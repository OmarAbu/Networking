...
import re
import tempfile
correct="/Users/omarabu-rmaileh/Desktop/email hw1/correct.txt"
wrong_d="/Users/omarabu-rmaileh/Desktop/email hw1/wrong_domain.txt"
wrong_f="/Users/omarabu-rmaileh/Desktop/email hw1/wrong_format.txt"
wrong_r="/Users/omarabu-rmaileh/Desktop/email hw1/wrong_recipient.txt"
s=open(correct, 'r') 
contents=s.read()
...
if '250' != recFrom[:3]:
    print('250 reply not received from server')
# Then, the SMTP client sends one or more RCPT (short for recipient) commands in 
the format of RCPT TO: < recipient address >.
# Send the RCPT TO command, including the email address of the recipient, and 
return the status code 250
#clientSocket.sendall(('RCPT TO: <' + toAddress + '>\r\n').encode())
rcpt_to = f"RCPT TO: {tEmail} \r\n"
cSocket.send(rcpt_to.encode())
recTo = cSocket.recv(1024).decode()
#recvTo = clientSocket.recv(1024).decode()  # Note that UDP uses sendto and 
recvfrom
print(recTo)
if '250' != recTo[:3]:
    print('250 reply not received from server')
